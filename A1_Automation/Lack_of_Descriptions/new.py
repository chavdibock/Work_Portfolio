        ...
        with open(file_path, 'r') as device_config:
            ...
            for n in range(len(vpls_sap_int)):
                ...
                if physical_port_db[n] == "" or physical_port_db[n] == "unmanaged":
                    print('/configure service {0} {1} name {2} customer {3} sap {4} description "{2}"'.format(type_of_servise[n],
                                                                                                              vpls_srvID[n],
                                                                                                              vpls_name[n],
                                                                                                              vpls_customer[n],
                                                                                                              vpls_sap_int[n]))

                    result.write('/configure service {0} {1} name "{2}" customer {3} sap {4} description "{2}"\n'.format(type_of_servise[n],
                                                                                                                       vpls_srvID[n],
                                                                                                                       vpls_name[n],
                                                                                                                       vpls_customer[n],
                                                                                                                       vpls_sap_int[n]))
